...
A calm, local-first invoice builder for freelancers and small teams. Built as a local-first, dependency-light product experience with a self-contained Windows desktop app, a portable Windows build, and a scheduled Android APK release.
...
- [Windows downloads](https://github.com/bhargav-del/invoiceflow/releases/tag/v1.0.5)
- Portable: `Invoiceflow-Portable-1.0.5.exe`
- Installer: `Invoiceflow-Setup-1.0.5.exe`
